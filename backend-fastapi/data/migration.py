...
from common.config import DATABASE_URL_LOCAL, DATABASE_URL_PROD
...
db_source, db_target = normalize_url(DATABASE_URL_LOCAL), normalize_url(
    DATABASE_URL_PROD
)

db_source, db_target = db_target, db_source
